...
function PostContent({ post }: PostContentProps) {
  ...
  return (
<div
      className={`w-full h-full xl:h-[94%] relative xl:fixed xl:max-w-[25vw] min-[1800px]:max-w-[23vw] xl:top-0 xl:left-0 xl:bg-[#edece0] pb-6 xl:py-16 px-4 xl:pl-7 z-40 ${
    ...
    >      {/* Gradient Space */}
      ...
      <div className="xl:h-[80vh] flex flex-col justify-start xl:justify-center">
        {/* Title */}
        <h1 className="text-2xl xl:text-4xl font-cormorant font-medium tracking-tighter xl:mt-16">
          {post.title}
        </h1>
