  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
       ...
       <div className="absolute inset-0 md:bg-white/8" />


      {/* Title */}
      <h1 className="absolute text-gray-200 md:text-black uppercase text-4xl xl:text-[75px] top-[86vh] md:top-[9vh] tracking-widest">
        Peter Lippmann
      </h1>
    </div>
  )
