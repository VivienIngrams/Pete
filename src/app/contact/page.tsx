...
// Lazy load the contact form with reCAPTCHA
    ...
    <>
      ...
      <div className="min-h-screen !bg-white dark:!bg-white xl:h-[90%] flex flex-col items-center justify-center">
        <div className="mx-6 xl:w-1/3 xl:mx-auto">
          <h1 className="text-2xl xl:text-3xl w-full text-left font-light uppercase tracking-widest pt-24  pb-8">
            Contact
          </h1>

          <ContactForm />

          <div className="w-full text-center pb-12 md:pt-8">
            <p>
              {language === 'en'
                ? 'Or write to us at '
                : 'Ou écrivez-nous à '}
